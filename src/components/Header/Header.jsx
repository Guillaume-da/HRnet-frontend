...
const Header = () => {
	...
	return (
		<div className="relative h-20 sm:h-32 flex justify-between items-center bg:white dark:bg-zinc-800 mb-20  mx-2 md:mb-2 2xl:mx-28 px-4 dark:border-zinc-800 rounded dark:text-white">
