				...
				<div className="mx-2 w-full flex-1">
					...
					<div className="my-2 flex rounded border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-1" >
						<input
							...
							className="w-full appearance-none p-1 bg-white px-2 text-gray-400 dark:text-gray-500 outline-none dark:bg-zinc-800"
						/>
					</div>
				</div>
				<div className="mx-2 w-full flex-1">
					...
					<div className="my-2 flex text-gray-500 rounded border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-1" >
						<input
							defaultValue={lastName ? lastName : ''}
							onChange={(event) => dispatch({type: 'form/addEmployee', payload: {...form, lastName: event.target.value}}) }
							name="lastname"
							placeholder="Enter the Last Name"
							className="w-full appearance-none p-1 px-2 text-gray-400 dark:text-gray-500 outline-none dark:bg-zinc-800 dark:focus:bg-zinc-800 dark:active:bg-zinc-600"
						/>
					</div>
				</div>
				<div className="mx-2 w-full flex-1">
					...
					<div className="my-2 flex rounded border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-800 p-1" >
						<input
							...
							name="birthdate"
							type="date"
							className="w-full appearance-none p-1 px-2 text-gray-500 outline-none dark:bg-zinc-800"
						/>
					</div>
				</div>
			</div>
